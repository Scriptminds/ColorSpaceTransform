### Installation Instructions ColorSpaceTransform
...
2. Copy & Paste the ColorSpaceTransform file:
   - Copy the ColorSpaceTransform paste into the plugins folder.
...
7. open nuke:
   ...
   -Restart the Nuke and now you can enjoy the ColorSpaceTransform on the above toolbars.
